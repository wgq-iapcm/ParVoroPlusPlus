...
# possible options are --kdtree --blocks <totblocks> --threads <num_threads> --wrap --debug --files <num_files> --nx <nx> --ny <ny> --nz <nz> --xlo <domain.min[0]> --ylo <domain.min[1]> --zlo <domain.min[2]> --xhi <domain.max[0]> --yhi <domain.max[1]> --zhi <domain.max[2]>
opts="--debug --kdtree --blocks 64 --threads 1 --xlo 0 --ylo 0 --zlo 0 --xhi 1 --yhi 1 --zhi 1" 
